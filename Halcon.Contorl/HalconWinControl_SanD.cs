...
namespace HalControl
{
    ...
    /// halcon窗口控件
    /// </summary>
    public partial class HalconWinControl_SanD : UserControl
    {
        #region  全局变量
        ...
        /// 3d显示或2d显示标志
        /// </summary>
        bool _sanDHuoErDXianShiBiaoZhi = false;        
        #endregion
        ...
        /// 3D显示或2D显示标志
        /// </summary>
        public bool SanDHuoErDXianShiBiaoZhi
        {
            get { return _sanDHuoErDXianShiBiaoZhi; }
            set { _sanDHuoErDXianShiBiaoZhi = value; }
        }

        #endregion

        #region  初始化
        public HalconWinControl_SanD()
        {           
            InitializeComponent();
        }
        ...
        void DispImageFit()
        {
            try
            {
                if (_ho_Image.IsInitialized()&&!this._sanDHuoErDXianShiBiaoZhi)
                {
                    ...
                    if (ratio_win >= ratio_img)
                    {
                        ...
                        _begin_Col = (int)(-hv_imageWidth.D * (ratio_win / ratio_img - 1d) / 2d);
                        _endCol = (int)(hv_imageWidth.D + hv_imageWidth.D * (ratio_win / ratio_img - 1d) / 2d);
                    }
                    else
                    {
                        _begin_Col = 0;
                        _endCol = hv_imageWidth - 1;
                        _beginRow = (int)(-hv_imageHeight.D * (ratio_img / ratio_win - 1d) / 2d);
                        _endRow = (int)(hv_imageHeight.D + hv_imageHeight.D * (ratio_img / ratio_win - 1d) / 2d);
                    }
        ...
        #region  设置显示模式
        private void toolStripButton_erWeiXianShiMoShi_Click(object sender, EventArgs e)
        {
            if ((this._yunXingBiaoZhi == false) && (this.Exit_Image() == true))
            {
                if(toolStripButton_erWeiXianShiMoShi.Text == "二维显示")
                {
                    this.hWindowControl1.HalconWindow.ClearWindow();
                    HOperatorSet.SetPaint(this.hWindowControl1.HalconWindow, "3d_plot");
                    //this.hWindowControl1.HalconWindow.SetPaint(((new HTuple("3d_plot")).TupleConcat("shaded")).TupleConcat(8));
                    this.hWindowControl1.HalconWindow.SetWindowParam("display_grid", "false");
                  //  this.hWindowControl1.HalconWindow.SetLut("rainbow");
                    toolStripButton_erWeiXianShiMoShi.Text = "三维显示";
                    this.hWindowControl1.HalconWindow.DispObj(this.Ho_Image);
                    this._sanDHuoErDXianShiBiaoZhi = true;
                }
                else
                {
                    this.hWindowControl1.HalconWindow.ClearWindow();
                    HOperatorSet.SetPaint(this.hWindowControl1.HalconWindow,"default");
                   // this.hWindowControl1.HalconWindow.SetPaint("default");
                 //   this.hWindowControl1.HalconWindow.SetLut("rainbow");                    
                    toolStripButton_erWeiXianShiMoShi.Text = "二维显示";
                    this.hWindowControl1.HalconWindow.DispObj(this.Ho_Image);
                    this._sanDHuoErDXianShiBiaoZhi = false;
                }
            }
        }
        #endregion
